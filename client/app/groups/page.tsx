        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 p-6">
            <div className="mx-auto max-w-7xl">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">Group Expenses</h1>
                        <p className="text-zinc-600 dark:text-zinc-400">Split expenses with friends and track payments</p>
                    </div>
